...
public class TopTenSection : IHomeScreenSection
{
    ...
    public TopTenSection(IUserManager userManager, ICollectionManager collectionManager, IDtoService dtoService)
    {
    ...
    public QueryResult<BaseItemDto> GetResults(HomeScreenSectionPayload payload, IQueryCollection queryCollection)
    {
        ...
        BoxSet? collection = _collectionManager
            .GetCollections(user)
    ...
    public IEnumerable<IHomeScreenSection> CreateInstances(Guid? userId, int instanceCount)
    {
        ...
        sections.Add(
            new TopTenSection(_userManager, _collectionManager, _dtoService)
            {
